    ...
    private class BandwidthSaverListener extends PacketListenerAbstract {
        ...
        public void onPacketSend(PacketSendEvent event) {
            ...
            if (type == PacketType.Play.Server.SPAWN_ENTITY) {
                ...
                com.github.retrooper.packetevents.protocol.entity.type.EntityType entityType = spawnPacket.getEntityType();
                // 盔甲架和矿车 100% 放行，解决机器重置概率不识别问题
                if (entityType == EntityTypes.ARMOR_STAND ||
                    entityType == EntityTypes.MINECART ||
                    entityType == EntityTypes.CHEST_MINECART ||
                    entityType == EntityTypes.COMMAND_BLOCK_MINECART ||
                    entityType == EntityTypes.FURNACE_MINECART ||
                    entityType == EntityTypes.HOPPER_MINECART ||
                    entityType == EntityTypes.SPAWNER_MINECART ||
                    entityType == EntityTypes.TNT_MINECART) {
                    return;
                }
